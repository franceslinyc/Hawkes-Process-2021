...
Similarly, $W_2$ also $\sim exp(\frac{1} {\lambda})$ since
...
In the previous cases, whether the events arrive at a constant rate $\lambda$ (e.g. Poisson process) or depend on an intensity function $\lambda (t)$ (e.g. nonhomogeneous Poisson Process), they arrive independently. Beginning here, we discuss cases in which the events do not arrive independently.
