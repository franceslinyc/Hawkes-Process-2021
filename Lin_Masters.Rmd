...
2. (Stationarity) If the distribution of the numbers of events $N(t)$ depends only on the length of the interval $t$, a counting process is said to have stationary increments. Stationarity implies homogeneity.

3. (Homogeneity) If the transition probability between any two states at two times depends only on the difference between the states, a stochastic process is said to be homogeneous. 
