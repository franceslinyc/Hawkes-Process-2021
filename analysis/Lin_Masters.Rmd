...
In the following sections, we discuss conditional intensity models. Examples of such models include Cox, cluster, and Hawkes processes. First, we want to define conditional intensity function.

**Definition 2.4.0** (Conditional Intensity Function) Let $N(t)$ be the numbers of events $N(t)$ that occur in any interval of time $t$ , the conditional intensity function $lambda(t)$ associated with $N(t)$ is defined as 
...
**Definition 2.4.2** (Cluster Process) 
...
Under assumption 1 - 4, it is a Neyman-Scott process. Under assumption 1 - 5, the cluster process is a Cox process. Under assumption 1 - 6, we have Matern cluster process and Thomas cluster process. 
