...
or if we let n to be the numbers of events occur in the interval $[a, b]$, then 
...
In the following sections, we discuss conditional intensity models. Such models include Cox, cluster, and Hawkes processes. 
