...
**Definition 2.4.1**  (Cox Process) Let **X** be a Poisson process with intensity function $\Lambda (t)$, then **X** is a Cox process with intensity function $\lambda (t) = E(\Lambda (t))$.
...
**2.4.1** Specific models of cluster processes depend on the choices of assumptions.
...
Broadly put, thinning algorithm involves deleting points from a point pattern. 
