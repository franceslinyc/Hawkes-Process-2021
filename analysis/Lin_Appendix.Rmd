...
Instead of setting `lambda` to be a deterministic function as in the NPP case, here we can set `lambda` to be a random function or variable. In Figure 3, `lambda` is set to be $=rexp(n = 1, rate = 1/100)$.
