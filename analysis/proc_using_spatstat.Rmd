...
par(mfrow=c(1, 1))
plot(rpoispp(lambda = 100, win=square(1)),main = "HPP (rate = 100)")
...
par(mfrow=c(1, 1))
plot(rpoispp(lambda = function(x, y) 400*x*y, win=square(1)), main = "NPP (intensity = 100*x)")
...
```{r}
plot(rMatClust(kappa = 100, r = 0.05, mu = 5), main = "Matern (kappa = 100, r = 0.05, mu = 5)")
```
