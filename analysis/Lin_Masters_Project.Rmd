...
Nonhomogeneous Poisson process has additional properties such as if the number of events in any time interval $(t, t+h]$, $N((t, t+h])$, $N(t)$ $\sim Pos(\Lambda (t) = \int_{t}^{t+h} \lambda (v) dv)$. That is, for all $v, t \geq 0$ and $n = 0, 1,...$, 
