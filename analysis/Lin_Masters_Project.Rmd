...
For an HPP, the number of events in any time interval, $N(t)$, are Poisson distributed. More formally, we can say that the number of events in any time interval $(h, t+h]$, $N((h, t+h])$ $\sim Pos(\lambda t)$. That is, for all $h, t \geq 0$ and $n = 0, 1,...$, 
...
$$
P(N(h + t) - N(h) = n) = P(N(t) - N(0)) = P(N(t) = n) = \frac{(\lambda t)^n e^{-\lambda t}} {n!} . \ \ 
$$
...
$$
P(W_2 > t | W_1 = h) = P(N(t + h) - N(h) | N(h) - N(h^{-}) = 1) = P(N(t + h) - N(h)) = P(N(t) = 0) = e^{-\lambda t}. 
$$
