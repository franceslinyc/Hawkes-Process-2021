...
Since the intensity, or the expected rate in which points occur over some time and space, of the process is now as a function of past history, we refer to the expected rate as a conditional intensity function. Hawkes processes self-excites because of this conditional intensity function since conditioning on the past set of events, the expected rates at which points occur are expected to be higher when points have occurred in nearby time and space and then they gradually decline as the events get further away in time and space. This characteristic is captured by the summing part of the conditional intensity function.
