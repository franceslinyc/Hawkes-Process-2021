...
Examples that are potentially better modeled as Cox processes than HPP include seedlings and saplings of California redwood, locations of emergent plants, and locations of trees (Baddeley, 2015). In these examples, there appear to be some underlying random variables or random fields (e.g. light, water, humidity, soil) that make it more likely to observe the seedlings or redwoods preferentially in some areas as supposed to others. 
