...
Exponentially decaying functions, which decay fast, has been applied to financial data (Embrechts et al., 2011). On the other hand, power-law kernel, which has a flatter tail, has been used in seismology (Ozaki, 1979) and social media (Rizoiu et al., 2017).
