...
$$
where $\lambda(v)$ **??** denotes a non-constant rate function. 
...
Hawkes process defined in term of a conditional intensity function is as follows (Rizoiu, 2017; Reinhart, 2018) 
...
Choices of $\phi(\cdot)$ include, for example, exponentially decaying function and power-law kernel, and they take the form of (Rizoiu, 2017)
$$
...
Spatio-temporal self-exciting processes are an extention of temporal Hawkes processes. Recall that temporal Hawkes processes take the form of 

$$
\lambda(t | \mathcal{H}_{t}) = \mu + \sum^{}_{i: T_i < t} g(t - t_i) .
$$

Spatio-temporal self-exciting processes take the form of 
