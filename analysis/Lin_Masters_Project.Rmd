...
Let us look at a more explicit example (Figure 1). Suppose that $N(t)$ counts the numbers of event up to some time $t$ and if event occurs at time $t = 1, 1.5, 3, 5, etc$, then $N(4) = 3$ since 3 events occur in the time interval $(0, 4]$. 
