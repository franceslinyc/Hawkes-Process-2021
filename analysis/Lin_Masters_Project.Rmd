...
Figure 2 shows a realization of a HPP in time. First, we note that the cumulative number of points grows at a constant linear rate. We can also see that the histogram of rate appears roughly uniform, i.e., the rates are roughly constant at $\lambda = 10$. The algorithm used for simulating this HPP can be found in the Appendix section.
