...
HPPs are independent, stationary, and homogeneous. The distribution of the numbers of events, $N(t)$, depends only on the length of the interval $h$.
...
Relaxing the independence assumptiont to allow for dependence between events make the models even more flexible
