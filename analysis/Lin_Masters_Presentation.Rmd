...
SEPP have not gained enough attention from the machine learning communities given their predictive capabilities beneficial. Some relevant point processes (e.g. nonhomogeneous Poisson, Cox and cluster processes) are often left out from graduate-level, introductory spatial statistics and stochastic processes courses.
