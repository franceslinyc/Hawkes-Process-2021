...
*Disclaimer:* Process 1-3 are perhaps review with details omitting. Check paper or the reference section of the paper for more!
...
HPPs can be used to model the number of events such as 
...
I want to thank Dr. James Molyneux for his constant support and encouragement while advising this Master's project, Dr. Lisa Madsen & Dr. Charlotte Wickham for their willingness to co-advise as I press on for the PhD program here at OSU, Dr. Sarah Emerson for both academic and nonacademic support that played major roles in my decision to pursue the PhD here, my cohort, our previous cohort and other PhD students for reassuring us that we will make it too despite the ongoing challenges, my family and friends, and especially my 92-year-old grandma for hanging in there while battling brain tumor since last year. 
