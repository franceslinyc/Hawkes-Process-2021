...
- When points have occurred in nearby time and/or space, the intensity at which points occur are expected to be higher and then the intensity gradually decline as the events get further away.
...
3. using $min( {\lambda^*} / {\lambda}, 1)$ as the accepting probability to randomly keep or 'thin' the points.
